...
export const HISTORICAL_WARHEADS: Record<string, Record<number, number>> = {
  "United States": {
    1939: 0, 1944: 0,
    1945: 6, 1950: 369, 1955: 3057, 1960: 20434, 1965: 31642, 1967: 31255,
  ...
  Russia: {
    ...
    1970: 11736, 1975: 23435, 1980: 30665, 1985: 39197, 1986: 40159,
...
const TIMELINE_YEARS = [1939, 1944, 1945, 1950, 1955, 1960, 1965, 1967, 1970, 1975, 1980, 1985, 1986, 1990, 1995, 2000, 2005, 2010, 2015, 2020, 2025];
...
/** Geographic centers for each nuclear-armed state (used for Historic Mode country markers). */
export const COUNTRY_CENTERS: Record<string, { lat: number; lng: number }> = {
  ...
  "United Kingdom": { lat: 54.37, lng: -2.0 },
...
export type HistoricEventCategory =
  | "test"
  | "bombing"
  | "close_call"
  | "treaty"
...
export interface HistoricEvent {
  ...
  title: string;
  description: string;
  category: HistoricEventCategory;
  /** If set, a flash effect is shown at this location on the globe. */
  lat?: number;
  lng?: number;
  country?: string;
}
...
export const HISTORIC_EVENTS: HistoricEvent[] = [
  {
    ...
    year: 1939,
    title: "Manhattan Project Origins",
    description: "Following Einstein's letter to Roosevelt warning of German atomic research, the US initiates secret work that will become the Manhattan Project — the most ambitious scientific endeavor in history.",
  ...
  },
  {
    ...
    day: 16,
    title: "Trinity Test",
    description: "The world's first nuclear detonation at Alamogordo, New Mexico. A 21 kiloton plutonium device. J. Robert Oppenheimer recalled the Bhagavad Gita: 'Now I am become Death, the destroyer of worlds.'",
    category: "test",
    lat: 33.68,
    lng: -106.48,
    country: "United States",
  },
  {
    ...
    day: 6,
    title: "Hiroshima",
    description: "Little Boy, a uranium gun-type bomb, is dropped on Hiroshima. The 15 kiloton blast kills an estimated 70,000–80,000 people instantly, with total deaths reaching 90,000–166,000 by year's end.",
    category: "bombing",
    lat: 34.39,
    lng: 132.45,
    country: "United States",
  },
  {
    ...
    day: 9,
    title: "Nagasaki",
    description: "Fat Man, a plutonium implosion bomb, is dropped on Nagasaki. The 21 kiloton blast kills 40,000–80,000 people. Japan surrenders six days later, ending World War II.",
    category: "bombing",
    lat: 32.77,
    lng: 129.87,
    country: "United States",
  },
  {
    ...
    month: 8,
    day: 29,
    title: "Soviet Joe-1 Test",
    description: "The USSR detonates its first nuclear device (RDS-1) at Semipalatinsk, ending the US nuclear monopoly. The arms race begins in earnest.",
    category: "test",
    lat: 50.07,
    lng: 78.43,
    country: "Russia",
  },
  {
    ...
    month: 11,
    day: 1,
    title: "Ivy Mike: First H-Bomb",
    description: "The US detonates the world's first thermonuclear device at Enewetak Atoll. The 10.4 megaton explosion — 700 times the Hiroshima bomb — obliterates the island of Elugelab.",
    category: "test",
    lat: 11.5,
    lng: 162.33,
    country: "United States",
  },
  {
    ...
    month: 8,
    day: 12,
    title: "Soviet Thermonuclear Test",
    description: "The USSR tests Joe-4, a 400 kiloton 'layer cake' thermonuclear design at Semipalatinsk, becoming the second nation capable of hydrogen bomb warfare.",
    category: "test",
    lat: 50.07,
    lng: 78.43,
    country: "Russia",
  },
  {
    ...
    day: 1,
    title: "Castle Bravo",
    description: "The US detonates a 15 megaton thermonuclear weapon at Bikini Atoll — the largest US test ever. The yield was 2.5× higher than expected, spreading fallout across 7,000 sq miles and contaminating a Japanese fishing vessel.",
    category: "test",
    lat: 11.7,
    lng: 165.33,
    country: "United States",
  ...
  {
    id: "france-gerboise-bleue",
    year: 1960,
    month: 2,
    day: 13,
    title: "France Joins the Club",
    description: "France detonates Gerboise Bleue — a 70 kiloton device in the Algerian Sahara — becoming the fourth nuclear power. France remains the only country to test on foreign territory.",
    category: "test",
    lat: 24.08,
    lng: 5.05,
    country: "France",
  },
  {
    ...
    day: 30,
    title: "Tsar Bomba",
    description: "The USSR detonates the AN602 hydrogen bomb over Novaya Zemlya — the largest nuclear weapon ever tested at 50 megatons. The fireball was 8 km wide; the mushroom cloud reached 67 km high.",
    category: "test",
    lat: 73.85,
    lng: 54.5,
    country: "Russia",
  },
  {
    ...
    description: "For 13 days in October, the US and USSR stand at the brink of nuclear war after Soviet missiles are discovered in Cuba. The closest humanity has ever come to nuclear conflict. Resolved by a secret deal.",
    category: "crisis",
    lat: 22.0,
    lng: -79.5,
  },
  {
    ...
    description: "The US, USSR, and UK sign the PTBT, banning nuclear tests in the atmosphere, underwater, and in space. Underground tests remain permitted. The first major nuclear arms control agreement.",
    category: "treaty",
    lat: 55.75,
    lng: 37.62,
  },
  {
    ...
    month: 10,
    day: 16,
    title: "China's First Test",
    description: "China detonates its first nuclear device (codenamed 596) at Lop Nur, becoming the fifth nuclear power. The 22 kiloton device used uranium-235.",
    category: "test",
    lat: 41.39,
    lng: 88.33,
    country: "China",
  },
  {
    ...
    month: 1,
    day: 17,
    title: "Palomares B-52 Crash",
    description: "A US B-52 carrying four thermonuclear bombs collides with a tanker over Spain. Two bombs' explosives detonate, spreading plutonium contamination. One bomb was recovered from the sea after 80 days.",
    category: "close_call",
    lat: 37.25,
    lng: -1.79,
    country: "United States",
  },
  {
    ...
    description: "The NPT opens for signature, recognizing five nuclear-weapon states. Now has 191 signatories. India, Pakistan, and Israel never joined; North Korea withdrew in 2003.",
    category: "treaty",
    lat: 40.75,
    lng: -73.98,
  },
  {
    id: "india-smiling-buddha",
    year: 1974,
    month: 5,
    day: 18,
    title: "India's Smiling Buddha",
    description: "India conducts its first nuclear test, Operation Smiling Buddha, at Pokhran — an 8 kiloton device. India claims it is a peaceful nuclear explosive, not a weapon.",
    category: "test",
    lat: 27.07,
    lng: 71.77,
    country: "India",
  },
  {
    ...
    day: 22,
    title: "Vela Incident",
    description: "A US Vela satellite detects a double flash in the South Atlantic consistent with a nuclear test. Widely suspected to be a joint Israeli-South African test. The US never officially confirmed.",
    category: "close_call",
    lat: -47.0,
    lng: 40.0,
  },
  {
    ...
    month: 9,
    day: 26,
    title: "Petrov Saves the World",
    description: "Soviet officer Stanislav Petrov receives warning of five incoming US ICBMs. Correctly judging it a false alarm from a satellite malfunction, he reports a system error — not an attack. His decision prevents nuclear war.",
    category: "close_call",
    lat: 54.75,
    lng: 37.5,
    country: "Russia",
  },
  {
    id: "soviet-peak",
    year: 1986,
    title: "Soviet Arsenal Peaks",
    description: "The Soviet nuclear arsenal reaches its all-time peak of approximately 40,159 warheads — more than all other nuclear powers combined. The US simultaneously maintains ~24,000 warheads.",
    category: "development",
    lat: 55.75,
    lng: 37.62,
    country: "Russia",
  },
  {
    ...
    day: 8,
    title: "INF Treaty",
    description: "Reagan and Gorbachev sign the Intermediate-Range Nuclear Forces Treaty, eliminating all ground-launched ballistic and cruise missiles with ranges of 500–5,500 km. 2,692 missiles destroyed.",
    category: "treaty",
    lat: 38.9,
    lng: -77.04,
  },
  {
    ...
    description: "The US and USSR sign the Strategic Arms Reduction Treaty, limiting deployed strategic warheads to 6,000 per side. Signed just months before the USSR's collapse.",
    category: "treaty",
    lat: 55.75,
    lng: 37.62,
  },
  {
    ...
    month: 12,
    title: "USSR Collapse",
    description: "The Soviet Union dissolves, leaving nuclear weapons in four successor states: Russia, Ukraine, Belarus, and Kazakhstan. By 1996, all non-Russian warheads were transferred to Russia.",
    category: "development",
    lat: 55.75,
    lng: 37.62,
    country: "Russia",
  },
  {
    ...
    month: 9,
    day: 10,
    title: "CTBT Opens for Signature",
    description: "The Comprehensive Nuclear-Test-Ban Treaty opens for signature. 178 nations sign, but it has not entered into force — key holdouts include the US, China, India, and Pakistan.",
    category: "treaty",
    lat: 40.75,
    lng: -73.98,
  },
  {
    ...
    month: 5,
    day: 11,
    title: "India's Pokhran-II Tests",
    description: "India conducts five nuclear tests at Pokhran, including a thermonuclear device. India declares itself a nuclear weapons state, triggering immediate international sanctions.",
    category: "test",
    lat: 27.07,
    lng: 71.77,
    country: "India",
  },
  {
    ...
    month: 5,
    day: 28,
    title: "Pakistan's Chagai Tests",
    description: "Pakistan detonates five nuclear devices at Chagai, becoming the seventh declared nuclear power — 17 days after India's tests. Pakistan claims it has achieved nuclear deterrence.",
    category: "test",
    lat: 28.96,
    lng: 64.8,
    country: "Pakistan",
  ...
  {
    id: "north-korea-test-1",
    year: 2006,
    month: 10,
    day: 9,
    title: "North Korea's First Test",
    description: "North Korea detonates a sub-kiloton nuclear device at Punggye-ri, drawing global condemnation and UN Security Council sanctions. North Korea claims to have joined the nuclear club.",
    category: "test",
    lat: 41.33,
    lng: 129.08,
    country: "North Korea",
  },
  {
    ...
    description: "Obama and Medvedev sign New START in Prague, limiting each country to 1,550 deployed strategic warheads and 700 deployed delivery vehicles — the most comprehensive arms reduction treaty since START I.",
    category: "treaty",
    lat: 50.08,
    lng: 14.44,
  },
  {
    ...
    month: 7,
    day: 7,
    title: "Nuclear Prohibition Treaty",
    description: "122 countries adopt the Treaty on the Prohibition of Nuclear Weapons at the United Nations — the first legally binding international agreement to comprehensively ban nuclear weapons. None of the nine nuclear-armed states participated.",
    category: "treaty",
    lat: 40.75,
    lng: -73.98,
  },
  {
    ...
    month: 8,
    day: 2,
    title: "INF Treaty Collapses",
    description: "The US withdraws from the INF Treaty, citing Russian violations. Russia suspends its participation. The landmark 1987 agreement terminates, removing constraints on intermediate-range missiles for the first time in 32 years.",
    category: "development",
    lat: 38.9,
    lng: -77.04,
  },
  {
    id: "russia-suspends-new-start",
    year: 2023,
    month: 2,
    day: 21,
    title: "Russia Suspends New START",
    description: "Putin announces Russia is suspending participation in the New START Treaty, citing Western support for Ukraine. The decision leaves no binding nuclear arms control framework between the US and Russia for the first time since 1972.",
    category: "development",
    lat: 55.75,
    lng: 37.62,
    country: "Russia",
